...
%This, aside from the fact that implementing the buttons via interrupts instead of polling is more energy-efficient and was part of the explicit assignment, is mostly due to actual name of the course: Energy Efficient Computer Design.
